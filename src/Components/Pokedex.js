...
import { Grid, Box, ListItem, List, ListItemText, Container } from '@mui/material';
          ...
          <Grid item xs={6} sx={{ overflowY: 'scroll', maxHeight: '80vh' }}>
            <List>
              {pokemonList.map((poke) => (
                <ListItem className={classes.listItem} key={poke.name} onClick={() => selectPokemon(poke.name)}>
